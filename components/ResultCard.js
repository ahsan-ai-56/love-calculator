...
export default function ResultCard({
  ...
  return (
    <div className="calculator-card rounded-soft p-6 md:p-8">
      ...
      <div ref={cardRef} className="bg-transparent p-6 rounded-soft">
        <p className="text-xs uppercase tracking-wide text-gold-600 font-semibold text-center mb-4">
        ...
        <p className="font-display text-5xl md:text-6xl font-semibold text-gold-600 text-center my-4">
          {score}%
        </p>
