...
import { friendshipContent } from "../../utils/toolsContent";

export default function FriendshipCalculator() {
  const [result, setResult] = useState(null);
  const { lang } = useLanguage();
  const t = friendshipContent[lang];
  ...
  return (
    <Layout>
      <Seo
        title="Friendship Calculator by Name – Fun Friendship Compatibility Score"
        description="Check a fun friendship compatibility score using two names. Free, instant, and perfect for best friends and siblings."
        path="/tools/friendship-calculator"
        schema={faqSchema}
      />
        ...
        <div className="max-w-xl mx-auto">
          {!result ? (
            ...
            <ResultCard
              ...
              toolLabel="Friendship Calculator"
      ...
      <section className="container-page prose-content max-w-3xl mx-auto pb-16">
        ...
        <p>
          {t.p3Pre}{" "}
          <Link href="/" className="text-rose-600 underline">{t.p3Link}</Link>
          {t.p3Post}
        </p>
